...
# This demo presents the minimum radius enclosing ball using user specified percentage of data and the minimum radius
# enclosing ball of 100% data as a new point is added by the user.
...
while xflag == 1:
    try:
        x = float(input("Enter x coordinate of the first point between -50 and 50, x: "))
        xflag = 0
    except ValueError:
...
while yflag == 1:
    try:
        y = float(input("Enter y coordinate of the first point between -50 and 50, y: "))
        yflag = 0
    except ValueError:
        print("Please enter a float number.")
